...
[LIVE DEMO!](https://github.com/christopherseaman/datasci_217/blob/main/08/demo/DEMO_GUIDE.md)

![Research vs. Practical](attachment:220ce280-94f3-4ddf-aa26-006550e96f64:mediaresearch.png)
...
![The list includes polio, Guinea worm, and this one particular enterovirus strain that they've been tracking out of spite after it went around the lab a few years ago.](attachment:f0fb5ad6-3a1b-4d81-a03e-93b226073e3c:image.png)
...
# 1. Log out of remote session
exit
# 2. Use SSH Copy to retrieve the file
...
# Detach (Ctrl+a d) back to login session
...
# Since we're lazy, we might skip naming the session
tmux new
...
# Since we're lazy
tmux a -t data_analysis

# Can omit the session name and will connect to last connected session
tmux a
```

!["What? I can't hear--" "What? I said, are you sure--" "CAN YOU PLEASE SPEAK--”](attachment:f1aecafa-03b1-44f1-a0b5-b82832cc15d1:image.png)
...
![Performance Benchmarks - All comparisons on 10M rows (lower is better)](attachment:895b78fe-a497-44b4-b9ad-ca33ee0f818f:mediaperf_combined.png)
...
![Punk vs. Process](attachment:04c5d810-424d-4d97-a615-31d94b3280f0:mediapunk.png)
